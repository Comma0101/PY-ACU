  ...
  <Container className="p-7">
      ...
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption className="d-flex text-dark t-1 align-items-center justify-content-center">
            <h3>ACUSPA</h3>
            <p>ACUSPA Offers Best Service!</p>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
    </Container>
    ...
    <Container className="p-5 mb-4 bg-light rounded-3 ">
      <Row className="p-12">
        <Col>
          <Card style={{ width: "auto", height: "100%" }}>
            <Card.Img style={{ height: "100%" }} variant="top" src={pic5} />
            <Card.Body>
        ...
        <Col>
          <Card style={{ width: "auto", height: "100%" }}>
            <Card.Img style={{ height: "100%" }} variant="top" src={pic3} />
            <Card.Body>
              ...
              <Card.Text>
                ...
                gentle or strong pressure to the muscles and joints of the body
                to ease pain and tension. A massage therapist is a person
                trained in giving massages. 10 Min Neck &Shoulder $9.99, 30 Min
                Body Pressure $20
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <Col>
          <Card style={{ width: "auto", height: "100%" }}>
            <Card.Img style={{ height: "100%" }} variant="top" src={pic2} />
            <Card.Body>
      ...
      <Row className="">
        <Col>
          <Card style={{ width: "auto", height: "100%" }}>
            <Card.Img style={{ height: "100%" }} variant="top" src={pic4} />
            <Card.Body>
