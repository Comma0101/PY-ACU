  ...
  return (
    <div>
      <div className="row d-flex align-items-stretch">
              ...
              <div className="card-body">
                ...
                <div className="col">
                  <p className="card-text">
                    ...
                    and improve range of motion. A Enhance immunity by
                    stimulating lymph flow—the body's natural defense system.
                    Exercise and stretch weak, tight, or atrophied muscles. Help
        ...
        <div className="col">
          <div style={{ width: "30rem" }} className="container h-10">
            <div className="card h-100 booking-card v-2 mt-2 mb-4 rounded-bottom">
              <div
