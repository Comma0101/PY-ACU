...
const App = () => (
  <Container className="p-7">
    ...
    <Container className="p-5 mb-4 bg-light rounded-3">
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption className="d-flex text-dark position-static b-2 t-2 align-items-center justify-content-center">
    ...
    <Container className="p-5 mb-4 bg-light rounded-3 ">
      <Row className=" p-3">
        <Col>
          <Card className="p-7" style={{ width: "26rem" }}>
