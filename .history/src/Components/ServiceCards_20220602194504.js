  ...
  return (
    <div>
      <div className="row align-items-start">
        <div className="col">
          <div style={{ width: "40rem", height: "10px" }} className="container">
              ...
              <div className="card booking-card v-2 mt-2 mb-4 rounded-bottom">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    foot reflexology is the practice of stimulating nerves in
                    the foot that lead to relaxation and through this stress
                    reduction that leads to better overall health. The benefits
                    of stress reduction are well known and documented in the
                  ...
                  <div className="row align-items-start">
                    <div className="col">60 mins</div>
                    <div className="col chip ms-3">0$</div>
                  </div>
                </div>
              </div>
            </section>
